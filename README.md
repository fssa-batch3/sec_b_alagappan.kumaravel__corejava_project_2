...
A[Address Service: Find by Address id] --> B[From Validation]
...
- User name length does not match pattern

- First name can't be null or empty
- First name length does not match pattern

- First name does not match pattern

- Last name length does not match pattern
...
- [ ] Implement Player Service(log in)

- [ ] Implement Player DAO (log in)
...
A[User Service: log in player] --> B[Form Validation]

B --> C{Check player available}

C -- Yes --> E[User DAO: log in player]

C -- No --> F[User Service: player not exist]

E --> H[User Service: Player loged in]
...
- [ ] Implement Team Service(find by id)

- [ ] Implement Team DAO (find by id)

- [ ] Implement Team Member Service(find by id)

- [ ] Implement Team Member DAO (find by id)
